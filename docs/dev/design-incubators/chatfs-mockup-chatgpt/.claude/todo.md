...
- [ ] [pyright-clean sweep across the incubator](todo.kb/2026-07-05-000-pyright-clean-sweep-across-the-incubator.md)
      — 16 `reportMissingTypeArgument` errors (bare `dict`/`Mapping`) + ~170
      cascading warnings in real files, surfaced by verifying the
      `chatfs_layout.py` extraction (commit b0665ce).
