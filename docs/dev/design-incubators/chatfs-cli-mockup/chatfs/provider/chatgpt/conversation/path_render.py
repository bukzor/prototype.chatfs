...
chatfs_atomic.py's module docstring for the mechanism; `staged` takes
data_dir's write lock itself (from chatfs_locks, reentrant), so no
separate lock acquisition is needed here.
"""
import sys
