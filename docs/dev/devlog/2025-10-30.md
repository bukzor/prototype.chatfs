...
- **Isolated fork representation problem**
  - Created fork-representation-design/ subdirectory
...
Documented in:
[design-rationale.md#jsonl-for-data-interchange](../design-rationale.md#jsonl-for-data-interchange)
...
Documented in:
[design-rationale.md#documentation-first-approach](../design-rationale.md#documentation-first-approach)
...
- Finish documentation structure:
  ...
  - Create docs/dev/design/api-reference.md
...
- [STATUS.md](../../../STATUS.md) - Updated with M0 progress
- [design-rationale.md](../design-rationale.md) - Core design decisions
- [development-plan.md](../development-plan.md) - Milestone roadmap
- [design-incubators/fork-representation/](../../../fork-representation-design/) -
  Fork design exploration (needs moving)
...
- **TBD?:** Modular AI coding assistant (aider/claude-code competitor)

claifs serves as a test case for composable tool design. Plumbing tools will
work in capnshell by swapping JSONL → capnproto serialization. The TBD?
assistant could use claifs to pull relevant past conversations as context.
