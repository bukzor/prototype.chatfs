...
**Technical documentation** for developers: (not exahautive)
...
- User-facing tutorials (goes in docs/examples/)
- Quick setup instructions (stays in HACKING.md)
- Active design problems (goes in design-incubators/)
