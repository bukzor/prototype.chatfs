...
Usage:
    chatfs-provider-chatgpt-index --cache <dir>
...
def main() -> None:
    ...
    chatfs_sh.pipe(
        [sys.executable, "-m", "chatfs.provider.chatgpt.index.browse", "--cache", cache],
        [sys.executable, "-m", "chatfs.provider.chatgpt.index.splat", "--cache", cache],
    )
