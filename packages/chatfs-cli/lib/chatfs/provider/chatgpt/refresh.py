#!/usr/bin/env python3
"""Refresh the ChatGPT cache: index it, then capture what changed.

Usage:
    chatfs-provider-chatgpt-refresh [--cache <dir>] <days>

Runs `index`, keeps the chats ChatGPT says changed within the last
