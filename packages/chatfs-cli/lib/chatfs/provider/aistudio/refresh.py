#!/usr/bin/env python3
"""Refresh the AI Studio cache: index it, then capture what changed.

Usage:
    chatfs-provider-aistudio-refresh [--cache <dir>] <days>

Runs `index`, keeps the chats AI Studio says changed within the last
