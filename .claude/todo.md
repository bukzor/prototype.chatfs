...
- [x] #4: json `parse_float=Decimal` — eliminate float intermediary for timestamps
- [x] #1: inspect empty text_content data, add test, decide fix for `extract_text_content` returning ""
- [x] #6: convert enumerate_conversation_links recursion to stack-based iteration
...
- [x] har2jsonl.py should use idiomatic json (`.json` module instead of stdlib `json`)
